...
<html>
  <head>
    ...
    <%
      ...
      .appendContext("var qOperator={0}.val()||\"\";",JQueryModel.id(inputOperator))
      ...
      **/
      ...
      datagridBuslog
      .appendAttrs(EasyUiModel.DataGrid.Properties.URL,buslogActionPath+"/datagrid/buslog.action",true)
