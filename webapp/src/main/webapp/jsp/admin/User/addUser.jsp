  ...
  <head>
   ...
   function clickSave(){
			   $("#formUser").form('submit',{
				   url:"<%=adminUserPath%>/do/addUser.action"
       ...
       <table class="editTable" cellspacing="0">
         <tbody>
           <tr>
             <th>用户名</th>
             <td style="width: 35%">
               <input name="CLoginName" type="text" 
            ...
            <th>密码</th>
             <td style="width: 35%">
               <input name="CPwd" type="text" 
               	class="<%=EasyUiModel.ValidateBox.CLASS %>"
               	<%=EasyUiModel.ValidateBox.Properties.MISSING_MESSAGE("密码必须输入！") %>
                 <%=EasyUiModel.ValidateBox.Properties.REQUIRED(true) %>
               />
             </td>
           </tr>
            ...
            <td style="width: 35%">
             <input name="<%= UserModel.F.IRoleid %>" 
  	         ...
  	         editable="false"
  	                  ...
  	                  <%=EasyUiModel.ValidateBox.Properties.MISSING_MESSAGE("角色号码必须输入！") %>
                 <%=EasyUiModel.ValidateBox.Properties.REQUIRED(true) %>
                   />
             </td>
           </tr>
