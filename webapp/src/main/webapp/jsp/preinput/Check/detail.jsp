...
<img style="width:300px" style="height:300px"  src="<%=basePath%>preinput/Check/stream/photo.action"  alt="审核人照片" />
</td>
</tr>
<tr >
<td >姓名</td>
...
<input type="button" value="审核" style="width:10%" onclick="clickcheck() "/>
</td>
</tr>
</tbody>
</table>
