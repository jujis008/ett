...
<div
		...
		<div
			...
			<br />
			<br /> 
			<!-- <input class="btnmain" value="申请检验合格标志补打" onclick="javascript:document.location.href='<s:url value="/self/addPrintApply!car.action"/>';" type="button" /> <br />
			 --><br /> <input  class="btnmain" value="申请驾驶证体检回执补打" onclick="javascript:document.location.href='<s:url value="/self/addPrintApply!hospital.action"/>';" type="button" />
			<br />
			<br /> <input  class="btnmain" value="申请处罚决定书补打" onclick="javascript:document.location.href='<s:url value="/self/addPrintApply!vio.action"/>';" type="button" />
			<br />
