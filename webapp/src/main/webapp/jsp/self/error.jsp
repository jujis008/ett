...
<p style="color:#FFEEDD;font-family:宋体;font-size:22pt;font-weight: bolder;text-shadow: #FEFEFE;">
			...
			<br />
			<input onclick="javascript:document.location.href='<s:url value="/self/index!logout.action"/>';" type="button" style="line-height:58px;background-position:center;width:144px;height:58px;background: url('<s:url value="/images/returnhome.jpg"/>')  no-repeat center" />
		</div>
</body>
