...
<tr class="<s:if test="#stuts.even==true">selftablecontentEven</s:if>">   
    ...
    <td ><s:date name="yyrq" format="yyyy-MM-dd"/></td>   
     <td ><s:date name="ksrq" format="yyyy-MM-dd"/></td>
      <td >  <input type="button" style="width:200px" class="btnmain"  onclick="document.location.href='<s:url value="/self/print!hospitalPrint.action?lsh=" /><s:property value="lsh"/>';" value="查看"/></td>  
</tr>   
</s:iterator> 
    </table>  
