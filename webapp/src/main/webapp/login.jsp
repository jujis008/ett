 ...
 <center>
   <div id="loginDiv" style=" background-image: url('<%=basePath %>images/mainback.jpg'); width:595px;height:53px;padding-top: 230px;">
        <form action="<%=adminUserPath %>/do/login.action" method="post">
          ...
          用户帐号<input name="loginName" style="width: 150px" type="text" class="easyui-validatebox" required="true" value="admin" ></td>  &nbsp;&nbsp;
         密码 <input name="pwd" style="width: 150px" type="password" class="easyui-validatebox" required="true" value="BKkQ2ROUZ7A="></td>  &nbsp;&nbsp;          
